            ...
            <div class="itemLeft">
                ...
                <div class="seller">
                    <div v-for="shop in shopfilter" :key="shop.id">
                        <h2 class="nameShop">{{ shop.shopName }}</h2>
                    </div>
                ...
                <div class="user">
                    <h2>ลูกค้า</h2>
                    <p> {{ this.addressname }} {{ this.addressnumber }} </p>
                    <p> {{ this.addressaddress }} ต.{{ this.addressSubdistrict }} อ.{{ this.addressdistrict }}</p>
                    <p>จ.{{ this.addressprovince }} {{ this.addresspostalCode }} </p>
                </div>
            </div>
            <div class="itemRight">
                <h2 class="title">ใบกำกับภาษี/ใบเสร็จรับเงิน</h2>
                <div class="seller2">
            ...
            axios.get(`http://localhost:8081/users/address?email=${userEmail}`)
                .then(response => {
                    if (response.data) {
                        ...
                        this.addressSubdistrict = addressData.Subdistrict;
