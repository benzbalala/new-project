<template>
    <div id="Purchase-history-left">
        <div class="user">
            ...
            <div class="item">
                <font-awesome-icon :icon="['fas', 'basket-shopping']" class="icons" v-show="isVisible"/>
            ...
            <div class="item">
                <font-awesome-icon :icon="['fas', 'receipt']" class="icons" v-show="isVisible"/>
        ...
        <div v-if="userRole === 'seller'" class="user">
            ...
            <div class="item">
                <font-awesome-icon :icon="['fas', 'file-invoice-dollar']" class="icons" v-show="isVisible2"/>
                <!-- <font-awesome-icon :icon="['fas', 'cart-flatbed']" class="icons" v-show="isVisible2"/> -->
                <p v-show="isVisible2"><router-link to="/OrderHistory" class="custom-link">ประวัติสินค้าที่ถูกขาย</router-link></p>
            </div>
            <div class="item">
